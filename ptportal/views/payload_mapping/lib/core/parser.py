...
class Parser(object):
    def __init__(self, finding_entries, payload_entries):
        ...
        self.mapping_data_dir = ("/code/ptportal/views/" +
                                 "payload_mapping/lib/data/")
    ...
    def init_file_types(self):
        """ Creates File Types """
        for file_type_name, file_type_properties in self.assessment_map["filetypes"].items():
    ...
    def init_obfuscations(self):
        ...
        for obfuscation_name, obfuscation_properties in self.assessment_map["obfuscations"].items():
